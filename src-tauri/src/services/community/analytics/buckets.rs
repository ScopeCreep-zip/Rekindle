...
pub(crate) fn day_floor_ms(unix_ms: i64) -> i64 {
...
pub(crate) fn empty_skeleton(now_ms: i64) -> Vec<DailySample> {
...
pub(crate) fn merge_into_skeleton(
...
pub(crate) fn window_start_ms(now_ms: i64) -> i64 {
