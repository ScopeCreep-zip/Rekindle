use super::super::helpers::{hex_to_id_16, u32_to_role_id};

pub(crate) fn governance_onboarding_to_manifest_shape(
...
pub(crate) fn onboarding_mode_to_string(
...
pub(crate) fn governance_welcome_to_protocol(
...
pub(crate) fn protocol_question_to_governance(
...
pub(crate) fn protocol_guide_step_to_governance(
...
pub(crate) fn protocol_welcome_channel_to_governance(
