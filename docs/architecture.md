...
├─────────────────────────────────────────────────────────┤
│                   Tauri 2 IPC Bridge                    │
│  ~170 commands, 6 event channels, 7 windows             │
...
│  Tier 7   dm/files/video/link-preview                   │
...
| 7 | `rekindle-dm`, `rekindle-files`, `rekindle-video`, `rekindle-link-preview` | Self-contained features built on lower tiers. |
...
crates/                               (16 workspace members — see crates.md)
