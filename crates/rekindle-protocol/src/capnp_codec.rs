...
// community.capnp — V1 encode/decode removed (rekindle-server excluded from workspace).
// Community data now uses JSON via manifest.rs / member_registry.rs modules.
