//! Event-plane leaf codecs plus the typed-id helpers: event info with
//! recurrence/location, member summary, voice roster, onboarding
//! answers, and the pseudonym/uuid16/id conversions.

use super::super::len_u32;
use crate::capnp_codec::{capnp_err, text_to_string};
use crate::dht::community::envelope::{OnboardingAnswer, VoiceRosterEntry};
...
pub(crate) fn write_recurrence_rule_via_event_capnp(
...
pub(crate) fn read_event_location_via_event_capnp(
...
pub(crate) fn write_member_summary(
...
pub(crate) fn read_member_summary(
...
pub(crate) fn write_voice_roster_entry(
...
pub(crate) fn read_voice_roster_entry(
...
pub(crate) fn write_onboarding_answer(
...
pub(crate) fn read_onboarding_answer(
...
pub(crate) fn pseudonym_key_to_capnp(
...
pub(crate) fn pseudonym_key_from_capnp(
...
pub(crate) fn uuid16_from_capnp(
