...
use crate::v3::io::encode::{EncodedFrame, FrameEncoder};
use crate::v3::context::OutboundFrame;
use crate::v3::wire::constants::{ENVELOPE_LEN, DIRECTION_ID_D2L};
...
impl FramePipeline {
    ...
    pub fn build_channel_packet(
        &self, kind: crate::v3::wire::frame_kind::ChannelKind, payload: &[u8],
    ) -> EncodedFrame {
    ...
    pub fn build_control_packet(
        ...
        match class {
            x if x == FrameClass::Channel as u8 => {
                let k = crate::v3::wire::frame_kind::ChannelKind::try_from(kind)
            ...
            x if x == FrameClass::Datagram as u8 => {
                let k = crate::v3::wire::frame_kind::DatagramKind::try_from(kind)
    ...
    pub fn build_audit_packet(
        &self, kind: crate::v3::wire::frame_kind::AuditKind, payload: &[u8],
    ) -> EncodedFrame {
