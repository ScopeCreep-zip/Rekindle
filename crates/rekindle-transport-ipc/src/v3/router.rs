...
pub struct ReplyRouter {
    ...
    pub conn_handle: crate::v3::server::ConnectionHandle,
}
...
impl FrameRouter for ReplyRouter {
    ...
    fn on_request(&self, info: &ConnectionInfo, message_id: uuid::Uuid, sender_clearance: Clearance, payload: &[u8]) {
        ...
        let reply_payload = crate::v3::codec::datagram::reply::encode(
            &crate::v3::codec::datagram::reply::DatagramReplyPayload {
        ...
        let frame = crate::v3::context::OutboundFrame::Datagram {
            kind: crate::v3::wire::frame_kind::DatagramKind::Reply,
            payload: reply_payload,
        };
        let _ = self.conn_handle.outbound_tx.try_send(frame);
    }
