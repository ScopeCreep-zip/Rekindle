...
use crate::v4::audit::replay_filter::ReplayFilter;
use crate::v4::codec::aead::FrameCipher;
use crate::v4::codec::envelope::{self, EnvelopeInfo, EnvelopeError};
...
impl FrameDecoder {
    ...
    pub fn verify_envelope(
        ...
        let flag_bits = u16::from_le_bytes([
            envelope_bytes[crate::v4::wire::envelope::offsets::FLAGS],
            envelope_bytes[crate::v4::wire::envelope::offsets::FLAGS + 1],
        ]);
